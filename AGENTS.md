...
(`.Codex/settings.local.json`) e registram conector MCP (Supabase, Resend,
...
Existem agentes especializados em `.Codex/agents/` para Mercado Livre e Webmotors —
...
- `docs/ferramentas-Codex-mcp.md` — conectores MCP do Supabase (read-only x
...
- **Checklist do que falta**: `docs/manual-operacional-contexto.md` lista
  ...
  sendo por iniciativa da skill `manual-operacional` (`.Codex/skills/`),
