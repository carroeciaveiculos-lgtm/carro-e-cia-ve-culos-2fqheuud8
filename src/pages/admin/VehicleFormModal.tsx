                          ...
                          <div>
                            ...
                            <div className="mt-1">
                              <CpfInput
                                ...
                                onChange={(val) =>
                                  setFormData({ ...formData, proprietario_cpf: val })
                                }
                                onNameFound={(nome) =>
                                  setFormData({ ...formData, proprietario_nome: nome })
                                }
                                className="h-8 text-xs bg-white"
                                buttonClassName="h-8 bg-blue-50 hover:bg-blue-100 text-blue-700 border-blue-200"
                              />
                            </div>
                          </div>
                        </div>
