...
import { getBlogImageUrl, getCategoryColor } from '@/lib/blog-utils'
      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-10 bg-card p-4 rounded-xl shadow-sm border border-border/50 sticky top-[70px] z-30">
          ...
          <div className="relative w-full md:w-96 shrink-0">
            ...
            <Input
              placeholder="buscar por assunto seguros consórcios e financiamentos"
              value={searchTerm}
            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {visiblePosts.map((post) => (
                ...
                >
                  ...
                  >
                    <picture>
                      <source srcSet={getBlogImageUrl(post)} type="image/webp" />
                      <img
