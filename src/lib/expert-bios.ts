...
const EXPERT_BIOS: Record<string, ExpertBio> = {
  'Adriana Araújo': {
    ...
    fotoUrl:
      'https://imagens.carroeciamotors.com.br/logos-e-imagens/fotos/adriana%20na%20mesa.jpeg',
  ...
  'Gabriel Araújo': {
    ...
    fotoUrl:
      'https://imagens.carroeciamotors.com.br/logos-e-imagens/fotos/gabriel%20na%20mesa.jpeg',
