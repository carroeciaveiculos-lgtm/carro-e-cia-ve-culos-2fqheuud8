...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { tema, palavraChave, tom, is_seo_copilot, title, is_seo_optimizer, current_data } = await req.json()
...
`
    ...
    const prompt = is_seo_optimizer ? `${basePrompt}
