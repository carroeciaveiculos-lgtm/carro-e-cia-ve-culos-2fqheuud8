...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (method === 'GET' && action === 'dashboard') {
      ...
      return json({ ativos: ativos || 0, erros: erros || 0, pendentes: pendentes || 0, ultima_sincronizacao: integracao?.ultima_sincronizacao || null, ultimo_erro: integracao?.ultimo_erro || null, status_conexao: integracao?.status || 'desconectado' })
    }
