-- Achado real 26/08/2026 (pedido da Adriana): editar SO a descricao (ou
-- qualquer outro campo tecnico) de um veiculo ja publicado no Mercado Livre
-- nunca reenviava a atualizacao -- o gatilho so disparava reenvio quando
-- Preco, Status ou Exibir no site mudavam. Confirmado com dado real: 9
-- veiculos ativos tinham sido editados depois da ultima sincronizacao real.
-- Corrigido: gatilho agora tambem dispara quando Descricao, Quilometragem,
-- Cor, Combustivel, Cambio, Portas, Direcao, Cilindrada, Versao ou
-- Categoria mudam -- os campos que realmente compoem o anuncio no ML.
