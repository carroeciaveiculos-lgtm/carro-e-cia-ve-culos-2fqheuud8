...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM auth.users WHERE email = 'adriana.araujo@kmzero.com.br') THEN
    ...
    VALUES (new_user_id, 'adriana.araujo@kmzero.com.br', 'Adriana Araujo', 'admin', true, 'admin', ARRAY['estoque', 'crm', 'avaliacao', 'design', 'financiamento', 'administrativo'])
