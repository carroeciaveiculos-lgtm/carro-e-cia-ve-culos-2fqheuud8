...
CREATE TABLE IF NOT EXISTS public.conversation_history (
    ...
    sender TEXT NOT NULL CHECK (sender IN ('bot', 'client', 'human')),
    message_text TEXT NOT NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

-- 3. Indexes
CREATE INDEX IF NOT EXISTS idx_conversation_history_lead_id ON public.conversation_history(lead_id);
